    ...
    <div class="col-md-12">
		...
		<div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Tìm <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Phần <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[7]" value="<?php echo $lang_ids[7]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Hình <span>*</span></label>
                    <div class="col-sm-6">
		...
		<div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Đăng nhập với <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Chọn một phương pháp <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[35]" value="<?php echo $lang_ids[35]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">MOMO <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[36]" value="<?php echo $lang_ids[36]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Quét mã <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[37]" value="<?php echo $lang_ids[37]; ?>">
                    </div>
                </div>
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thanh toán qua ngân hàng <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">				
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Ôn tập <span>*</span></label>
                    <div class="col-sm-6">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Tổng tạm tính <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Quay lại Trang tổng quan<span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Tỉnh thành <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[108]" value="<?php echo $lang_ids[108]; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mã zip <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
				...
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Địa chỉ trên bản đồ <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Thành phố không thể trống rỗng. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[127]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[127]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Trạng thái không thể trống. <span>*</span></label>
                    <div class="col-sm-6">
                        <textarea name="lang_value[128]" class="form-control" cols="30" rows="10" style="height:70px;"><?php echo $lang_ids[128]; ?></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Mã Zip không được để trống. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Địa chỉ email không giống. <span>*</span></label>
                    <div class="col-sm-6">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Email của bạn đã được xác minh thành công. Bây giờ bạn có thể đăng nhập vào trang web. <span>*</span></label>
                    <div class="col-sm-6">
