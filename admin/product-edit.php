...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Bạn phải chọn một danh mục cấp độ cuối<br>";
    }
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Giá cũ<br><span style="font-size:10px;font-weight:normal;">(Bằng Đồng)</span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Giá hiện tại <span>*</span><br><span style="font-size:10px;font-weight:normal;">(Bằng Đồng)</span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
			                    <input type="button" id="btnAddNew" value="Thêm mục" style="margin-top: 5px;margin-bottom:10px;border:0;color: #fff;font-size: 14px;border-radius:3px;" class="btn btn-warning btn-xs">
			                </div>
						</div>
						<div class="form-group">
