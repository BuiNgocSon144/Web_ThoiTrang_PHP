...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Tên danh mục hàng đầu đã tồn tại<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Danh mục hàng đầu được cập nhật thành công.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Chỉnh sửa danh mục cấp cao nhất</h1>
	</div>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Tên danh mục hàng đầu <span>*</span></label>
                    <div class="col-sm-4">
