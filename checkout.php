	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        ...
	                                        <option value="MOMO"><?php echo LANG_VALUE_36; ?></option>
	                                        <option value="Thanh toán qua ngân hàng"><?php echo LANG_VALUE_38; ?></option>
	                                    </select>
	                                </div>
                                    ...
                                    <form class="paypal" action="<?php echo BASE_URL; ?>payment/paypal/payment_process.php" method="post" id="paypal_form" target="_blank">
                                        ...
                                        <input type="hidden" name="currency_code" value="Đồng" />
